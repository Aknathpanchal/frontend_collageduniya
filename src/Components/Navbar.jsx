  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-between px-3  py-2">
        <div id="logo" className="" style={{ marginRight: "30%" }}>
          <a href="/">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="15 0 170 40" fill="currentColor">
              <defs> </defs>
        ...
        <div className="d-flex align-items-center align-content-center gap-2" >
          <span id="login_link_profile" className="btn btn-big hidden">
            <span>
              <svg width="18" height="18" fill="#464646" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path d="M224 256c70.7 0 128-57.31 128-128s-57.3-128-128-128C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3C77.61 304 0 381.6 0 477.3c0 19.14 15.52 34.67 34.66 34.67h378.7C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304z" />
              </svg>
            </span>
            <span className="js-loggedin-username"
              style={{
                marginLeft: "5px",
                textAlign: "left",
            ...
            <span className="down_arrow">
              <svg width="15" height="15" fill="#247cd5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            ...
            <div className="dropdown">
              <ul>
                ...
                <li>
                  <a> Logout </a>
                  {/* <form id="logout_form" action="/nc/logout" method="POST" style={{ display: "none" }}>
                      <input type="hidden" name="_token" value="qb9yP0hhsypDBhkaOh5bEdQ28Pz32jrUcarwagUX" />
                    </form> */}
                </li>
              </ul>
            </div>
          ...
          {!isAuth ?
            <Button
              ...
              onClick={() => isAuth ? handleLogout() : handleOpen()}
            >
              Login
            </Button> : (<div>
              <Button
                sx={{
                  borderRadius: "20px", padding: "8px 16px", backgroundColor: "white", color: "blue", '&:hover': {
          ...
          <span id="header_country" className="btn btn-big">
            <span>India</span>
            <img src="https://cdn.countryflags.com/thumbs/india/flag-round-250.png"
              alt="India" /> <span className="down_arrow">&#8964;
            </span>
            <div className="dropdown">
              <ul>
                <li> <a href="#"> <span>USA</span> <img src="https://cdn.countryflags.com/thumbs/united-states-of-america/flag-round-250.png" alt="United States Of America" /> </a> </li>
                <li> <a href="#"> <span>UAE</span> <img src="https://cdn.countryflags.com/thumbs/united-arab-emirates/flag-round-250.png" alt="United Arab Emirates" /> </a> </li>
              </ul>
            </div>
          </span>
        </div>
